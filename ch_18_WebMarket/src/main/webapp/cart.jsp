...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<table width="100%">
				<tr>
					<td align="left"><a href = "#" <%--  href="./deleteCart.jsp?cartId=<%=rs.getString("p_id")%>" --%> class="btn btn-danger">삭제하기</a></td>
					<td align="right"><a href = "#" <%-- href="./shippingInfo.jsp?cartId=<%= rs.getString("p_id") %>" --%> class="btn btn-success">주문하기</a></td>
				</tr>
			</table>
		</div>
